...
![almav Mapa Interativo](https://raw.githubusercontent.com/almav/emccamp.almav.com.br-aguasresidence/main/assets/images/screen01.jpg)
...
**Chave da API:** `18ec5437-8a05-48d3-acb7-439a7b808217`

## Demonstração

- Tela inteira (index.html): 
  - https://emccamp.almav.com.br/aguasresidence/

- Website DIV (exemplo02.html):
  - https://emccamp.almav.com.br/aguasresidence/exemplo02.html
  
- Aviso de rolagem da página (exemplo03.html):
  - https://emccamp.almav.com.br/aguasresidence/exemplo03.html

![almav Mapa Interativo](https://raw.githubusercontent.com/almav/emccamp.almav.com.br-aguasresidence/main/assets/images/screen02.jpg)
...
```html
    ...
    <script
        src="https://maps.app.almav.com/apiv2/js/almav-initmap.js?key=18ec5437-8a05-48d3-acb7-439a7b808217&callback=initMap"
        defer></script>
```
...
1. **Preparação Inicial**
   ...
   - Tenha em mãos a chave da API Almav: `18ec5437-8a05-48d3-acb7-439a7b808217`
